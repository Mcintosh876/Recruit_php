    ...
    <a class="navbar-brand" href="index.php">
      ...
      <div class="collapse navbar-collapse" id="navbarNavAltMarkup">
        <div class="navbar-nav mr-auto">
          ...
          <a class="nav-link" href="viewrecords.php">Recruits</a>
      ...
      <div class="navbar-nav ml-auto" >
       ...
       ?>
          ...
          <?php } else { ?> 
              ...
              <a class="nav-link active" aria-current="page" href="#">Welcome <?php echo $_SESSION['username'] ?><span class="sr-only"></span></a>
